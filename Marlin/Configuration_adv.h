...
#define ADVANCED_PAUSE_FEATURE  // MRiscoC Enabled
  ...
  #define PAUSE_PARK_RETRACT_FEEDRATE         22  // (mm/s) Initial retract feedrate.
  #define PAUSE_PARK_RETRACT_LENGTH            2  // (mm) Initial retract.
                                                  // This short retract is done immediately, before parking the nozzle.
  #define FILAMENT_CHANGE_UNLOAD_FEEDRATE     22  // (mm/s) Unload filament feedrate. This can be pretty fast.  // MRiscoC Increased filament unload speed
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_FEEDRATE  22  // (mm/s) Load filament feedrate. This can be pretty fast.  // MRiscoC Increased filament load speed
